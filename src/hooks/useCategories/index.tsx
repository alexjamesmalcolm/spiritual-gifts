...
const useCategories = (): Category[] =>
  [
    {
      ...
      description: (
        <div>
          <p>
            The spiritual capability to apply spiritual knowledge effectively.
            (1 Corinthians 12:8)
          </p>
          <p>
      ...
      description: (
        <div>
          ...
          <p>
            ...
            move away from your present ministry efforts. Make certain that
            there are appropriate provisions for the people that God has
            entrusted you in your present ministry.
          </p>
        </div>
      ),
    },
    {
      ...
      description: (
        <div>
          ...
          <p>
            Distinctives: A person with this gift is a hands-on person. He or
            she may be a builder, architect, designer; someone who enhances
            ministry by his other unique skills. The gift can be expressed in
      ...
      description: (
        <div>
          ...
          <p>
            ...
            application, with the ability to design attractive and catchy flyers
      ...
      description: (
        <div>
          ...
          <p>
            ...
            imbalance in teachings, the presence of demonic activity, or misuse
            of scripture. Discernment must be based on knowing Biblical truth.
            Once this person knows the truth, they can clearly pick out problems
    ...
    },
    {
      ...
      description: (
        <div>
          <p>
            The spiritual capability to reassure, strengthen, and affirm those
            who are discouraged or wavering in their faith. (Romans 12: 8)
          </p>
          <p>
      ...
      description: (
        <div>
          <p>
            ...
            Christ to non-Christians so they can respond in faith and move
            toward discipleship. (Ephesians 4:11)
          </p>
          <p>
    ...
    },
    {
      ...
      description: (
        <div>
          ...
          <p>
            Distinctives: This gift is often expressed in a strong prayer life.
            A person with this gift lives in constant awareness of the reality
            of the supernatural as well as the natural. This person is certain
            that God will bring to pass what He promises and is therefore
            reliable during trials. He or she can also help others see God
            working in trials.
          </p>
          <p>
    ...
    },
    {
      ...
      description: (
        <div>
          <p>
            The spiritual capability to contribute money and material resources
            to the work of the Lord with cheerfulness and liberality. (Romans
            12: 8)
          </p>
          <p>
            ...
            has often blessed this person with financial ability through
            increased income or other means in order to build up the Kingdom of
            God. Serving others this way causes a sense of joy, a sense of
      ...
      description: (
        <div>
          <p>
            ...
            accomplishment of practical and necessary tasks which support the
            body of Christ. (Romans 12:7; 1Corinthians 12:28)
          </p>
          <p>
          ...
          <p>
            ...
            world rejects - helping others for the sheer satisfaction of
            helping. A person with this gift edifies the body of Christ by
            supporting others in their pursuit of ministry. Like our Helper, the
            Holy Spirit, gifted helpers derive enjoyment out of serving others.
          </p>
          <p>
            Cautions: If you have this gift, you may often need help from the
            leadership to see clearly what will be most supportive for the
            church. You may also struggle with false humility. Because the
            effects are less dramatic and tangible, the tendency is to undermine
            the spiritual significance of your gift. The challenge is to think
            through your acts of service beyond their functional end. (For
            example, an individual helping clean walls and painting in a home to
            get ready for Home Church.)
          </p>
        </div>
      ),
    },
      ...
      description: (
        <div>
          ...
          <p>
            ...
            warm atmosphere for those whom God is calling to the church. They
            have an ability to connect with people; they provide environments
            where people feel welcome. This person tends to gravitate toward
            those who are standing off to the side, looking confused. A good
      ...
      description: (
        <div>
          ...
          <p>
            ...
            valued and should avoid using prayer as an escape from fulfilling
      ...
      description: (
        <div>
          ...
          <p>
            ...
            reclusive. You will have to balance time alone studying with pursuit
    ...
    },
    {
      ...
      description: (
        <div>
          ...
          <p>
            Distinctives: A person with this gift provides oversight. They have
            a natural tendency to nurture people and give them direction.
            Shepherds are willing to provide the long-term care needed to help
            others work through issues in their lives. They like to spend time
            with people, feeding, protecting and disciplining in love. They
            gravitate towards building discipleship relationships. Gifted
    ...
    },
    {
      ...
      description: (
        <div>
          <p>
            The spiritual capability to understand, clearly explain, and apply
            the Word of God to the lives of listeners. (Romans 12:7; 1
            Corinthians 12:28; Ephesians 4:11)
          </p>
          <p>
            Distinctives: Teachers have a real thirst for knowledge and have an
            insatiable desire to share that knowledge. A person with this gift
            can develop the ability to understand and fashion the message in a
          ...
          <p>
            ...
            be conveyed in a single teaching. The teaching itself must convey
            the most important truths and be practical. You may tend to be too
            profound or detail- oriented. Make certain that you keep the
            teaching focused enough for the audience to hear it and digest its
            application. It is also common for a teacher to struggle with pride
            because she or he often has more knowledge than others do. Be
            careful not to become upset with people who are not as excited about
            a truth as you are. Most importantly, make certain that you are as
            interested in people as you are in facts.
          </p>
          <p>
  ...
  ].sort((a, b) => (a.name > b.name ? 1 : -1)) as Category[];
